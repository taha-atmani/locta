...
<section class="sectb">
    <div id="menu">
        <div id="burgermenu" >
            <a href="#">Accueil</a>
            <p>________</p>
            <a href="profil.php?id=<?php echo $_SESSION['id']; ?>">Mon compte (<?php echo $_SESSION['pseudo']; ?> admin)</a>
            <p>________</p>
            <a href="parcourir2connect.php?id=<?php echo $_SESSION['id']; ?>">Parcourir</a>
            <p>________</p>
            <a href="#">Les réservations</a>
            <p>________</p>
            <a href="#">Contact</a>
            <p>___________</p>
...
<section class="sect2">
    <ul class="gallery">
        ...
        <li><a class="cadre" href=""><img src="ressource/22bmwm31.jpg" alt="" class="image"><span>Nouveau véhicule</span></a></li>
        <li><a class="cadre" href=""><img src="ressource/22urus.jpg" alt="" class="image"><span>Le plus populaire</span></a></li>
        <li><a class="cadre" href=""><img src="ressource/22audia7devant1.jpg" alt="" class="image"><span id="centrer">PROMOTION</span></a></li>
    </ul>
</section>
<section class="sect3">
